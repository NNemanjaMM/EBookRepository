	...
	<form action="/bookadd" method="POST">
		<table class="manage-data table-size-big">
			<tr>
				<td>Title:</td>
				<th colspan="2">
					<input type="text" name="title" id="title" class="form-control veryBigInput" Placeholder="Enter book title" required="required">
				</th>
			</tr>
			<tr>
				<td>Author:</td>
				<th colspan="2">
					<input type="text" name="author" id="author" class="form-control veryBigInput" Placeholder="Enter book author">
				</th>
			</tr>
			<tr>
			...
			<tr>
				<td>Keywords:</td>
				<th colspan="2">
					<input type="text" name="keywords" id="keywords" class="form-control veryBigInput" Placeholder="List book keywords">
				</th>
			</tr>
			<tr>
				<td>MIME:</td>
				<th colspan="2">
					<input type="text" name="MIME" id="MIME" class="form-control veryBigInput" Placeholder="Enter book MIME">
				</th>
			</tr>
			<tr>
				<td>Language</td>
			...
			<tr>
				<td>File location:</td>
				<th>
					<input type="text" name="filename" id="filename" class="form-control fileInput" required="required" Placeholder="Browse for book on your PC">
				</th>
				<td>
